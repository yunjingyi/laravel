...
<div class="col-lg-8">
    ...
    <div class="form-group{{ $errors->first('title', ' has-error') }}">
        {{ Form::label('title', '标题： ') }}
        {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => '請输入文章标题', 'required']) }}
    </div>
    
    <!-- Post Content -->
    <div class="form-group{{ $errors->first('content', ' has-error') }}">
        {{ Form::label('content', '文章內容： ') }}
        {{ Form::textarea('content', null, ['class' => 'form-control', 'placeholder' => '請输入文章內容', 'required']) }}
    </div>
    
    <!-- Post Category -->
    <div class="form-group{{ $errors->first('category_id', ' has-error') }}">
        {{ Form::label('category_id', '文章分类： ') }}
    ...
    <div class="form-group text-right">
        ...
        {{ Form::submit('发表', ['class' => 'btn btn-success']) }}
    </div>
